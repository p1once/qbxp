...
function CheckPlayerData(source, playerData)
    ...
    local fitnessConfig = config.player.fitness or {}
    local strengthConfig = fitnessConfig.strength or {}
    local enduranceConfig = fitnessConfig.endurance or {}
    ...
    playerData.metadata.strength = playerData.metadata.strength or strengthConfig.default or 50
    playerData.metadata.endurance = playerData.metadata.endurance or enduranceConfig.default or 50
    if playerState then
        ...
        playerState:set('strength', playerData.metadata.strength, true)
        playerState:set('endurance', playerData.metadata.endurance, true)
    end
...
function Logout(source)
    ...
    player.PlayerData.metadata.strength = playerState?.strength or player.PlayerData.metadata.strength
    player.PlayerData.metadata.endurance = playerState?.endurance or player.PlayerData.metadata.endurance
...
function SetMetadata(identifier, metadata, value)
    ...
    if not player.Offline then
        ...
        if (metadata == 'hunger' or metadata == 'thirst' or metadata == 'stress' or metadata == 'strength' or metadata == 'endurance') then
