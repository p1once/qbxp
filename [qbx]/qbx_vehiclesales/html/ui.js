var app = new Vue({
    ...
    methods: {
        ...
        resetForm() {
            ...
            this.sellPrice = "";
            this.errors = [];
            this.societyAccounts = [];
            this.allowPersonalPayment = true;
        },
        hideForm() {
...
function setupForm(data) {
    ...
    if (data.action === "buyVehicle") {
        ...
        app.allowPersonalPayment = paymentOptions.personal !== false;
        app.societyAccounts = paymentOptions.societies || [];
    } else {
        app.societyAccounts = [];
        app.allowPersonalPayment = true;
    }
}
