return {
    ...
    parked = 0.4, -- Density of parked vehicles
    vehicle = 0.4, -- Density of vehicles
    randomvehicles = 0.3, -- Density of random vehicles
    peds = 0.3, -- Density of random peds (civilians, etc.)
