return {
	...
	YouTool = {
        ...
        DigitalShop = {
                name = 'Digital Shop',
                blip = {
                        id = 521, colour = 26, scale = 0.8
                }, inventory = {
                        { name = 'phone', price = 750 },
                        { name = 'gps_tracker', price = 3500 }
                }, locations = {
                        vec3(-503.69, 291.47, 82.78),
                        vec3(-503.71, 291.99, 82.46),
                }, targets = {
                        { loc = vec3(-503.69, 291.47, 82.78), length = 1.0, width = 1.2, heading = 0.0, minZ = 82.58, maxZ = 83.18, distance = 2.0 },
                        { loc = vec3(-503.71, 291.99, 82.46), length = 1.0, width = 1.2, heading = 0.0, minZ = 82.26, maxZ = 82.86, distance = 2.0 }
                }
        },
