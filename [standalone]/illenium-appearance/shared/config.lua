...
Config.UseRCoreClothing = false -- When enabled and rcore_clothing is running, clothing menus forward to rcore
...
Config.ClothingRooms = {
    ...
    {
        job = "ambulance",
        coords = vector4(301.49, -599.02, 43.28, 349.02),
    ...
    {
        job = "ambulance",
        coords = vector4(-255.23, 6327.54, 32.43, 223.34),
        size = vector3(2.0, 2.0, 2.0),
        rotation = 45,
        usePoly = false
    }
